...
//sendmail.php
DEFINE('SENDMAIL', "INSERT into `mail` (`send_name`, `dest_name`, `title`, `message`) VALUES ('%s', '%s', '%s', '%s')");
//vote for points
DEFINE('V4P_RESULTA', "SELECT `blockendedtime`, `blockendedtime2`, `blockendedtime3`, `point`, `lastvisit` FROM `vote_point` WHERE `account_id`='%s'");
DEFINE('V4P_RESULTB', "SELECT ip_address,blockendedtime,blockendedtime2,blockendedtime3 FROM vote_point WHERE ip_address = '%s'");
?>
